...
const About = () => {
    return (
        <React.Fragment>
            ...
            <p className={'alternate-text'}>I am an experienced Application / Web Developer specialising in front end development, but I also have
            ...
            <p className={'alternate-text'}>My current goals are to move into a senior developer role and continue to learn and improve as a
