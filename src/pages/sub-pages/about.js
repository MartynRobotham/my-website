        ...
        <React.Fragment>
            ...
            <div className={'about-me-profile'}>
                ...
                <p className={'alternate-text'}>I am an experienced Application / Web Developer specialising in front
                    ...
                    React,
                    Angular and Progressive Web Applications (PWA). I have helped build customer portals and customer
                    facing
                    ...
                    applications.</p>
                <p className={'alternate-text'}>My current goals are to move into a senior developer role and continue
