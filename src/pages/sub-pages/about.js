    ...
    return (
        <div>
            ...
            <p>I am an experienced application/Web Developer, specialising in front end development but has also
                ...
                to help solve problems and help the business achieve their goals. I also have experience using SQL,
                Mongo and DynamoDB to store data when building web applications.</p>
